...
class JaaSJwtBuilder:
    ...
    def withDefaults(self):
        ...
        # Calculate seconds for one year
        ONE_YEAR_IN_SECONDS = 365 * 24 * 60 * 60

        return self.withExpTime(int(time.time() + ONE_YEAR_IN_SECONDS)) \
            ...
            .withSipOutboundCallEnabled(False) \
    ...
    try:
        ...
        with open(fp, 'r') as reader:
            ...
            token = jaasJwt.withDefaults() \
                .withApiKey("vpaas-magic-cookie-b8bac73eabc045188542601ffbd7eb7c/d7d9ee") \
                .withUserName("Ankit Anand") \
                .withUserEmail("ankit.anand@lenskart.com") \
                .withModerator(True) \
                .withAppID("vpaas-magic-cookie-b8bac73eabc045188542601ffbd7eb7c") \
